...
class A_configuraciones extends CI_Controller {
	...
	public function index() {
		if(!defined('CON_id_usuario') && $this->session->userdata('C_id_usuario')=="" ) {
			...
			$data_usua['titulo']="Parametrizaciones";
			$data_usua['origen']="Administración";
			$data_usua['contenido']='configuraciones/index';
			$data_usua['entrada_js']='_js/configuraciones.js';
	...
	public function listar_tabla() {
		if(!defined('CON_id_usuario') && $this->session->userdata('C_id_usuario')=="" ) {
			...
			if(!$this->input->is_ajax_request()) {
				...
				echo listar_configuraciones_tabla('WEB');
			}
		}
	}
