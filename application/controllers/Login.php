...
class Login extends CI_Controller {
                ...
                foreach ($resu as $row) {
                    ...
                    if($row->estado == "1") {
                        if($row->clave == $this->input->post('contrasena')) {
                            ...
                            // ---- SIN 2FA: Login normal (flujo actual) ----
                            ...
                            if($cambio_clave == '1'){
                                ...
                                $this->session->sess_regenerate(TRUE); // endurecer sesión
    ...
    // ============================
    // Segundo factor: verificación del código TOTP
    // ============================
