...
<div class="card acard mt-2 mt-lg-3">
	<div class="card-header">
        <h3 class="card-title text-125 text-primary-d2">
          <i class="fas fa-user-check text-dark-l3 mr-1"></i>
          Pacientes
        </h3>
    </div>
	<div class="row mt-3">
			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nuevo_paciente">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nuevo_paciente">Nuevo</span>
			          </button>
			          </div>
			        </div>
			      </div>
				      ...
				      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
				        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
				        	<tr>
		                      ...
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">N. Documento</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Nombre del Paciente</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Entidad de Salud</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Telefono</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Correo</th>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('a_pacientes/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
	                			...
	                			<div class="form-body">
				                    ...
				                    <div class="form-group row" id="div_fecha_nacimiento">
				                     ...
				                     <div class="form-group row" id="div_otro">
				                      <div class="col-sm-2 col-form-label text-sm-right pr-0">
				                        <?= form_label('Otro ','otra_entidad_salud', array('class'=>'mb-0','id'=>'lbotra_entidad_salud')); ?>
				                      </div>
				                      <div class="col-sm-10">
