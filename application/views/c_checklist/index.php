			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <a href="<?php echo base_url('c_documentosc/index')?>">
									<button type="button" class="btn btn-success px-3 d-block text-95 radius-round border-2 brc-black-tp10" id="btn_servicios">
										<i class="fa fa-file mr-1"></i>
										<span class="d-sm-none d-md-inline" id="btn_nueva_solicitud">Documentos</span>
									</button>
								</a>
