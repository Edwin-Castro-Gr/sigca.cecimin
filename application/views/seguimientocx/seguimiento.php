  ...
  <?= form_open(base_url('c_programacion/guardar_revision'), array('id'=>'form_revisar', 'name'=>'form_revisar', 'class'=>'mt-lg-3', 'autocomplete'=>'on')); ?>
    <div class="form-body " style=" justify-content:flex-start;" >
      ...
      <div class="form-group row" id="div_observaciones">
        ...
        <div class="col-sm-10">
          <?= form_textarea(array('rows'=>'2', 'name'=>'observaciones', 'id'=>'observaciones', 'placeholder'=>'Digite las observaciones si se requiere', 'class'=>'form-control ', 'Readonly'=>true, 'value'=>''));?>
        </div>
      </div>
      <div class="form-group row" id="div_observaciones">
        <div class="col-sm-2 col-form-label text-sm-right pr-0">
        ...
        <div class="col-sm-10">
          <?= form_textarea(array('rows'=>'2', 'name'=>'observaciones_r', 'id'=>'observaciones_r', 'placeholder'=>'Digite las observaciones si se requiere', 'class'=>'form-control ', 'Readonly'=>true, 'value'=>''));?>
        </div>
      </div>
        ...
        <br>
          ...
          <br>
          <div class="card-body px-3 pb-1">
            <h5 class="bgc-primary-d3 text-white brc-white p-15">Curso Quirurgico</h5>
            <div class="form-group row" id="div_seguimiento">
              <div class="col-sm-2 col-form-label text-sm-right pr-0">
                <?= form_label('Ubicacion del Paciente','salaqx', array('class'=>'mb-0')); ?>
              </div>
              <div class="col-sm-4">
                 <?= form_dropdown('ubicacion', $opcubicacion,'','class="form-control" id="ubicacion"');?>
              </div>
              <div class="col-sm-2 col-form-label text-sm-right pr-0">
