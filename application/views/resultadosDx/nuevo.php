			  ...
			  <div class="card-body px-1 px-md-3">
                ...
                <div class="form-group row" id="div_paciente" >
                  ...
                  <div class="col-sm-2 col-form-label text-sm-right pr-0">
			            ...
			            <div class="col-sm-4">
			            	<?= form_upload(array('type'=>'file', 'name'=>'archivov[]', 'id'=>'archivov', 'placeholder'=>'Cargar el Archivo del Resultado', 'class'=>'form-control ace-file-input col-sm-8 col-md-10', 'multiple'=>'multiple', 'required'=>true));?>
			            </div>
