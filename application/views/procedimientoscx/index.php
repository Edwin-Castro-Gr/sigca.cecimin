			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nuevo_procedimiento">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nuevo_procedimiento">Nuevo</span>
			          </button>
			          </div>
			        </div>
			      </div>
				      ...
				      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
				        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
				        	<tr>
		                      ...
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Tiempo</th>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('c_procedimientos/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
				      		<?= form_input(array('type'=>'hidden', 'name'=>'idregistro', 'id'=>'idregistro', 'value'=>'0'));?>
					        <div class="card-body px-3 pb-1">
	                			<div class="form-body">
				                    <div class="form-group row" id="div_nombre">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('Codigo *','codigo_cx', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= form_input(array('type'=>'text', 'name'=>'codigo_cx', 'id'=>'codigo_cx', 'placeholder'=>'Digite el Codigo CX', 'maxlength'=>'100', 'class'=>'form-control col-sm-9 col-md-10', 'required'=>true));?>
				                      </div>
				                    </div>
				                    ...
				                    <div class="form-group row" id="div_nombre">
				                      ...
				                      <div class="col-sm-8">
				                        <?= form_input(array('type'=>'text', 'name'=>'nombre', 'id'=>'nombre', 'placeholder'=>'Digite el Nombre del Procedimiento', 'maxlength'=>'100', 'class'=>'form-control col-sm-9 col-md-10 UpperCase', 'required'=>true));?>
				                      </div>
				                    </div>

				                    <div class="form-group row" id="div_nombre">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('Tiempo CX *','tiempo_cx', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= form_input(array('type'=>'text', 'name'=>'tiempo_cx', 'id'=>'tiempo_cx', 'placeholder'=>'##:##', 'maxlength'=>'5', 'class'=>'form-control col-sm-9 col-md-10'));?>
				                      </div>
				                    </div>
