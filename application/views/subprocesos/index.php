...
<div class="card acard mt-2 mt-lg-3">
	<div class="card-header">
        <h3 class="card-title text-125 text-primary-d2">
          <i class="fas fa-project-diagram text-dark-l3 mr-1"></i>
          Subprocesos
        </h3>
    </div>
	<div class="row mt-3">
			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nuevo_subproceso">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nuevo_subproceso">Nuevo</span>
			          </button>
			          </div>
			        </div>
			      </div>
				      ...
				      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
				        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
				        	<tr>
					          ...
					          <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Prefijo</th>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('a_subprocesos/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
				      		<?= form_input(array('type'=>'hidden', 'name'=>'idregistro', 'id'=>'idregistro', 'value'=>'0'));?>
					        <div class="card-body px-3 pb-1">
					        	<div class="form-group row" id="div_prefijo">
			                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
			                        <?= form_label('Prefijo*','prefijo', array('class'=>'mb-0')); ?>
			                      </div>
			                      <div class="col-sm-4">
			                        <?= form_input(array('type'=>'text', 'name'=>'prefijo', 'id'=>'prefijo', 'placeholder'=>'Digite el Prefijo', 'maxlength'=>'3', 'class'=>'form-control col-sm-9 col-md-10 UpperCase', 'required'=>true));?>
			                      </div>
				                </div>
	                			<div class="form-body">
				                    <div class="form-group row" id="div_proceso">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('Proceso *','id_proceso', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= select_procesos_tabla('subprocesos','','form-control col-sm-9 col-md-10" required="1');?>
				                      </div>
			                    	</div>
				                    ...
				                    <div class="form-group row" id="div_nombre">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('Nombre Subproceso*','Nombre', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= form_input(array('type'=>'text', 'name'=>'nombre', 'id'=>'nombre', 'placeholder'=>'Digite el Nombre', 'maxlength'=>'100', 'class'=>'form-control col-sm-9 col-md-10 UpperCase', 'required'=>true));?>
				                      </div>
				                    </div>
				                    ...
				                    <div class="form-group row" id="div_responsable">
				                      ...
				                      <div class="col-sm-8">
				                        <?= select_empleados_tabla('subprocesos','','select2 form-control col-sm-9 col-md-10');?>
				                      </div>
			                    	</div>
