...
<div class="card acard mt-2 mt-lg-3">
	<div class="card-header">
        <h3 class="card-title text-125 text-primary-d2">
          ...
          Preguntas de Rondas de Seguridad 
        </h3>
    </div>
	<div class="row mt-3">
		<div class="col-12">
			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			        	<div class="row mr-1">			       		
				          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nueva_pregunta">
				            <i class="fa fa-plus mr-1"></i>
				            <span class="d-sm-none d-md-inline" id="btn_nueva_pregunta">Nueva Pregunta</span>
				          </button>
				      ...
				      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
				        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
				        	<tr>
		                      ...
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Rondas</th>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('r_pregunta/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
	                	...
	                	<div class="form-body">
	                      ...
	                      <div class="col-sm-2 col-form-label text-sm-right pr-0">
	                        <?= form_label('Ronda *','rondas_preguntas', array('class'=>'mb-0')); ?>
	                      </div>
	                      <div class="col-sm-10">
	                      	<?= select_rondas_tabla('preguntas','','select2 form-control col-sm-9 col-md-10');?>
	                      </div>
                    	</div>
				                    
											<div class="form-group row" id="div_responsable">
	                      <div class="col-sm-2 col-form-label text-sm-right pr-0">
	                        <?= form_label('Sección *','secciones_preguntas', array('class'=>'mb-0')); ?>
	                      </div>
	                      <div class="col-sm-10">
	                      	<?= form_dropdown('secciones_preguntas', '', '', 'class="form-control col-sm-9 col-md-10" id="secciones_preguntas"');?>
	                    ...
	                    <div class="form-group row" id="div_ronda">
	                      ...
	                      <div class="col-sm-10">
	                        <?= form_textarea(array('rows'=>'2', 'name'=>'pregunta', 'id'=>'pregunta', 'placeholder'=>'Registre la pregunta', 'class'=>'form-control ', 'required'=>true));?>
	                      </div>
	                    </div>
