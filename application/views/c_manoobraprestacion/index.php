...
<div class="card acard mt-2 mt-lg-3">
	<div class="card-header">
        <h3 class="card-title text-125 text-primary-d2">
          ...
          Costo Mano de Obra Prestación de Servicios
        </h3>
    </div>
	<div class="row mt-3">
		<div class="col-12">
			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        <h3 class="text-125 pl-1 mb-3 mb-sm-0 text-secondary-d4">
			          listado de Costo Mano Obra Prestación de Servicios
			        </h3>
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nueva_manoobrapresta">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nueva_manoobrapresta">Nuevo</span>
			          </button>
			          </div>
			        </div>
			      </div>
				      ...
				      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
				        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
				        	<tr>
		                      ...
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Empleado</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Costo</th>
				    ...
				    <div class="modal-content">
				      <div class="modal-header bgc-primary-m1 brc-white">
				        <h5 class="modal-title text-white" id="newModalLabel">
				          Nuevo Costo Mano de Obra Prestacion de Servicios 
				        </h5>
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('Cc_manoobraprestacion/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
