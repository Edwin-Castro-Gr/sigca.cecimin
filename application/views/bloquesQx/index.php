			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nuevo_cargo">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nuevo_bloque">Nuevo</span>
			          </button>
			          </div>
			        </div>
			      </div>
				      ...
				      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
				        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
				        	<tr>
		                      ...
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Cirujaro</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Especialidad</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Día</th>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('c_bloquesQx/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
					        ...
					        <div class="card-body px-3 pb-1">
	                			<div class="form-body">
				                    <div class="form-group row" id="div_nombre">
				                      ...
				                      <div class="col-sm-8">
				                         <?= select_cirujanos_tabla('bloques','','select2  form-control style="width: 100%"');?>
				                      </div>
				                    </div>

														<div class="form-group row" id="div_titulo">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('Especialidad *','cargo', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= form_input(array('type'=>'text', 'name'=>'cargo', 'id'=>'cargo', 'placeholder'=>'Digite el Titulo del Cargo', 'class'=>'form-control col-sm-9 col-md-10 UpperCase'));?>
				                      </div>
				                    </div>

				                    <div class="form-group row" id="div_naturaleza">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('Frecuencia*','frecuencia', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= form_dropdown('frecuencia', $opfrecuencia, '1', 'class="form-control col-sm-9 col-md-10" id="frecuencia"');?>
				                      </div>
			                    	</div>

			                    	<div class="form-group row" id="div_naturaleza">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('día*','dia', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= form_dropdown('dia', $opdias, '', 'class="form-control col-sm-9 col-md-10" id="dia"');?>
				                      </div>
			                    	</div>

			                    	<div class="form-group row" id="div_titulo">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('Hora Inicio *','hinicio', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= form_input(array('type'=>'time', 'name'=>'hinicio', 'id'=>'hinicio', 'class'=>'form-control col-sm-9 col-md-10 UpperCase'));?>
				                      </div>
				                    </div>
				                    <div class="form-group row" id="div_titulo">
				                      <div class="col-sm-4 col-form-label text-sm-right pr-0">
				                        <?= form_label('Hora final *','hfinal', array('class'=>'mb-0')); ?>
				                      </div>
				                      <div class="col-sm-8">
				                        <?= form_input(array('type'=>'time', 'name'=>'hfinal', 'id'=>'hfinal', 'class'=>'form-control col-sm-9 col-md-10 UpperCase'));?>
				                      </div>
				                    </div>
