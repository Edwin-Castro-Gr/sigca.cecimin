          ...
          <?= form_open(base_url('c_programacion/guardar_solmateriales'), array('id'=>'form_smateriales', 'name'=>'form_smateriales', 'class'=>'mt-lg-3', 'autocomplete'=>'on')); ?>
            <div class="form-body " style=" justify-content:flex-start;" >
              ...
              <div class="form-group row" id="div_seccion2">
                ...
                <div class="col-sm-4">
                  <?= form_input(array('type'=>'date', 'name'=>'fechaprogramacion', 'id'=>'fechaprogramacion', 'placeholder'=>'Digite la fecha', 'class'=>'form-control','value'=>$c_fecha_programacion, 'disabled'=>true));?>
                </div>
                ...
                <div class="col-sm-4">
                    <?= form_input(array('type'=>'time', 'name'=>'horaprogramacion', 'id'=>'horaprogramacion', 'class'=>'form-control', 'value'=>$c_hora_programacion, 'disabled'=>true));?>
                </div>                
              </div>
              ...
              <div class="form-group row" id="div_tiempo">
                ...
                <?= form_input(array('type'=>'number', 'name'=>'tiempohoras', 'id'=>'tiempohoras', 'placeholder'=>'Horas', 'class'=>'form-control', 'min'=>"0", 'max'=>"24", 'required'=>true, 'value'=>$c_tiempoqxh));?>                    
                </div>
                <div class="col-sm-1 col-form-label text-sm-left pr-0">
                  <?= form_label('Horas','horas', array('class'=>'mb-0')); ?>
                </div>
                <div class="col-sm-1 col-xs-1">                      
                <?= form_input(array('type'=>'number', 'name'=>'tiempominutos', 'id'=>'tiempominutos', 'placeholder'=>'Min', 'class'=>'form-control', 'min'=>"00", 'max'=>"59", 'step'=>"5",'required'=>true, 'value'=>$c_tiempoqxm));?>                   
                </div>
                <div class="col-sm-1 col-form-label text-sm-left pr-0">
                  <?= form_label('Minutos','minutos', array('class'=>'mb-0')); ?>
                </div>
              </div>
                ...
                <div class="card-body px-2 pb-1">
                  <div class="form-body">
                    <div class="form-group row" id="div_procedimientos">
                      ...
                      <div class="col-sm-4">
                        <?= select_procedimientos_tabla('agendamiento','','form-control " required="1');?>
                      </div>
                    </div>  
                    ...
                    <div class="form-group row" id="div_adicionales">
                      <div class="col-sm-2 col-form-label text-sm-right pr-0">
                        <?= form_label('Adicionales ','adicionales', array('class'=>'mb-0')); ?>
                      </div>
                      <div class="col-sm-10">
                        <?= form_input(array('type'=>'text', 'name'=>'adicionales', 'id'=>'adicionales', 'placeholder'=>'Digite los adicionales', 'class'=>'form-control col-sm-11 col-md-12 UpperCase'));?>
                      </div>
                    </div>

                    <div class="form-group row" id="div_proveedor">
                      <div class="col-sm-2 col-form-label text-sm-right pr-0">
                        <?= form_label('Proveedor material','proveedor', array('class'=>'mb-0')); ?>
                      </div>
                      <div class="col-sm-4">
                        <?= select_terceros_tabla('agendamiento','','select2 form-control " required="1');?>
                      </div>
                    </div>  
                  </div><!-- /.Form-body Modal-->
                </div><!-- /.card-body Modal-->
                ...
                <div class="card-body px-2 pb-1">
                  <div class="form-body">
                    <div class="form-group row" id="div_identificacion">
                      ...
                      <div class="col-sm-2 col-form-label text-sm-right pr-0">
                        <?= form_label('Documento ','numero_id', array('class'=>'mb-0')); ?>
                      </div>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group row" id="div_estado">
                      ...
                      <div class="col-sm-6">
                        <?= form_dropdown('estado', $opciones, $c_estado, 'class="form-control col-sm-11 col-md-12" id="estado"');?>
                      </div>
                    </div>
                  </div><!-- /.Form-body Modal-->
                </div><!-- /.card-body Modal-->
