<input type="hidden" name="opc_pag" id="opc_pag" value="ingreso">
            ...
            <div class="card acard mt-2 mt-lg-3">
              ...
              <div class="card-body px-3 pb-1">
                <?= form_open(base_url('encuesta/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'mt-lg-3', 'autocomplete'=>'off')); ?>
                  ...
                  <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                    <div class="offset-md-3 col-md-9 text-nowrap">
                      ...
                      <?= anchor(base_url('encuesta/index'), '<i class="fa fa-undo mr-1"></i> Cancelar', array('class'=>'btn btn-danger btn-rounded m-t-10')); ?>
                    </div>
                  </div>
                <?= form_close(); ?>
              </div><!-- /.card-body -->
