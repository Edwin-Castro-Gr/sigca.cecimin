        ...
        <div class="col-12">
          <div class="card dcard">
            <div class="card-body px-3 pb-1">
              <?= form_open(base_url('linea_etica/guardar_gestion'), array('id'=>'form_gestion', 'name'=>'form_gestion', 'class'=>'mt-lg-3', 'autocomplete'=>'off')); ?>
                ...
                <div class="form-body " style=" justify-content:flex-start;" >
                  ...
                  <div class="form-group row" id="div_acciones">
                    ...
                    <div class="col-sm-10">
                        <?= form_textarea(array('rows'=>'4', 'name'=>'observaciones', 'id'=>'observaciones', 'placeholder'=>'Realice una breve descripción de la gestión realizada', 'class'=>'form-control w-100', 'value'=>$c_accion_mejora));?>
                    </div>
                  </div>
                  ...
                  <div class="form-group row" id="div_observaciones">
                    ...
                    <div class="col-sm-10">
                        <?= form_textarea(array('rows'=>'4', 'name'=>'accion', 'id'=>'accion', 'placeholder'=>'Registre un breve detalle de las Acciones y/o soluciones', 'class'=>'form-control w-100', 'value'=>$c_observaciones));?>
                    </div>
                  </div>
                ...
                <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                  <div class="offset-md-3 col-md-9 text-nowrap">
                    ...
                    <?= anchor(base_url('linea_etica/reporte'), '<i class="fa fa-undo mr-1"></i> Cancelar', array('class'=>'btn btn-danger btn-rounded m-t-10')); ?>
                  </div>
                </div>
