			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-red px-3 d-block text-95 radius-round border-2 brc-black-tp10 mr-1 ml-2" id="btn_conr">
			            <i class="fa fa-file-pdf mr-1"></i>
			          ...
			          <button type="button" class="btn btn-green px-3 d-block text-95 radius-round border-2 brc-black-tp10 mr-1" id="btn_excel">
			            ...
			            <span class="d-sm-none d-md-inline" id="btn_consultas">Consulta</span>
			          </button>
			          <button type="button" class="btn btn-green px-3 d-block text-95 radius-round border-2 brc-black-tp10 mr-1" id="btn_excel">
			            <i class="fa fa-database mr-1"></i>
