			        ...
			        <div class="mb-2 mb-sm-0">
				        ...
				        <!-- 	<button type="button" class="btn btn-online-red px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#importar" id="btn_upload">
			          	...
			          	<button type="button" class="btn btn-secondary px-3 d-block text-95 radius-round border-2 brc-black-tp10 mr-1 ml-2" id="btn_pdf">
					        ...
					        <a href="<?php echo base_url('d_doc_institucionales/nuevo')?>">
					          	<button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" id="btn_nuevo_documento">
					            	...
					            	<span class="d-sm-none d-md-inline" id="btn_nuevo_documentoins">Nuevo</span>
					          	</button>
					        </a>
			            </div>
			        </div>
				      ...
				      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
				        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
				        	<tr>
		                      ...
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Vence</th>
