                          ...
                          <div class="card-body">                          
                            ...
                            <div class="tab-content">
                                ...
                                <form id="form-1" enctype="multipart/form-data" metodo="post" class="row row-cols-1 ms-5 me-5 needs-validation" novalidate>                               
                                  <div class="form-group form-row mt-2">
                                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                                      <?= form_label('Tipo identificacion*','tipoide', array('class'=>'mb-0')); ?>
                                    </div>                             
                                    <div class="col-sm-4">
                                  ...
                                  <div class="form-group form-row mt-2" id="div_nombres_apellidos">
                                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                                      <?= form_label('Nombre del Paciente','nombres', array('class'=>'mb-0')); ?>
                                    </div>
                                    <div class="col-sm-10">
                              ...
                              <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2"> 
                                <form id="form-2" metodo="post" class="row row-cols-1 ms-5 me-5 needs-validation" autocomplete="off" novalidate >
                                  <div class="form-group form-row mt-2">
                                  ...
                                  <div class="form-group row" id="div_condicion">
                                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                                      <?= form_label('Condición del Paciente','condicion', array('class'=>'mb-0')); ?>
                                    </div>
                                     <div class="col-sm-4">
                              ...
                              <div id="step-3" class="text-center tab-pane" role="tabpanel" aria-labelledby="step-3">
                                <form id="form-3" metodo="post" enctype="multipart/form-data" class="row row-cols-1 ms-5 me-5 needs-validation" novalidate>
                                  ...
                                  <div class="form-group form-row mt-2" id="div_archivov">
                                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                                        <?= form_label('Formula Medica por especialista','orden_medica', array('class'=>'mb-0')); ?>
                                    </div>
                                    <div class="col-sm-10">                                      
