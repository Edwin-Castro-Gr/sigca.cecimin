			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <!-- <button type="button" class="btn btn-secondary px-3 d-block text-95 radius-round border-2 brc-black-tp10 mr-1 ml-2" id="btn_pdf">
			            ...
			            <span class="d-sm-none d-md-inline" id="btn_pdf">PDF</span>
    			          ...
    			          <button type="button" class="btn btn-green px-3 text-95 radius-round border-2 brc-black-tp10 mr-1 ml-2" data-toggle="modal" data-target="#view-excel" id="btn_excel">
    			            <i class="fa fa-database mr-1"></i>
    			            <span class="d-sm-none d-md-inline" id="btn_excel">Excel</span>
    			          </button>
    			          <button type="button" class="btn btn-blue px-3 text-95 radius-round border-2 brc-black-tp10 mr-1 ml-2" id="btn_reporte">
    				        <i class="fa fa-cancel mr-1"></i>
    				          <span class="d-sm-none d-md-inline" id="btn_reporte">Reporte</span>
    				      </button>			         
			          </div>
			        </div>
			      </div>
...
<!-- ***************************************** MODAL FILTRO CONSULTA EXVCEL ************************************************ -->
    <!-- Modal Nuevo  -->
    <div id="view-excel" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header card-success">
                ...
                <div class="modal-body" id="modalFormBody">
                    <form class="form-horizontal m-t-20" id="modalFormReporte">
                      ...
                      <div class="form-group row" id="div_filtroEstado">
                        <div class="col-sm-2 col-form-label text-sm-right pr-0">
                          <?= form_label('Estado','estado', array('class'=>'mb-0')); ?>
                        </div>
                        <div class="col-sm-10">                    
                          <?= form_dropdown('filestado', $opciones, '', 'class="form-control " id="filestado"');?>
                        </div>                                       
                      </div>
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-default waves-effect" data-dismiss="modal" id="btn_cancelar_modal">Cerrar</button>                 
                  <button type="button" class="btn btn-green waves-effect" data-dismiss="modal" id="btn_generar">Generar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="pdfModalLabel">Visualización de Ordenes</h5>
