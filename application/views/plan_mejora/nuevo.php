                    ...
                    <div class="form-body " style=" justify-content:flex-start;">   
                        ...
                        <section class=" form-group" id="sec_Quejas">    
                                ...
                                <div class="card ccard h-100">
                                    ...
                                    <div class="card-body px-1 px-md-3">
                                        <div class="d-flex justify-content-center flex-column flex-sm-row mb-3 px-2 px-sm-0">
                                            <div class="col-sm-12 mb-2 mb-sm-0">  
                                                    
                                                <div class="form-group row mr-1">
                                                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                                                        <?= form_label('Quejas *', 'txtqueja', array('class' => 'mb-0')); ?>
                                                    </div>
                                                    <div class="col-sm-10">                                                          
                                                        <?= form_textarea(array('rows' => '3', 'name' => 'txtqueja', 'id' => 'txtqueja', 'class' => 'form-control col-sm-9 col-md-12')); ?>
                                                    </div>
                                                </div>

                                                <div class="form-group row mr-1">
                                                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                                                        <?= form_label('Nombre del contacto*', 'txtcontacto', array('class' => 'mb-0')); ?>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <?= form_input(array('type' => 'text', 'name' => 'txtcontacto', 'id' => 'txtcontacto',  'class' => 'form-control col-sm-9 col-md-12')); ?>
                                                    </div>

                                                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                                                        <?= form_label('Servicio *', 'drogservicio', array('class' => 'mb-0')); ?>
                                                    </div>
                                                    <div class="col-sm-4">                                                           
                                                        <?= form_dropdown('drogservicio', $servicio, '', 'class="form-control col-sm-9 col-md-12" id="drogservicio"'); ?>
                                                    </div>                              
                                                </div>
                                                ...
                                                <div class="form-group row mr-1">                                                   
                                                    ...
                                                    <div class="col-sm-10">
                                                        <?= form_textarea(array('rows' => '2', 'name' => 'txthallazgo', 'id' => 'txthallazgo', 'class' => 'form-control col-sm-9 col-md-12')); ?>
                                                    </div>
                                                </div>  

                                                <div class="form-group row mr-1">
                                                     <div class="col-sm-2 col-form-label text-sm-right pr-0">
                                                        <?= form_label('Fecha Queja', 'txtfechaqueja', array('class' => 'mb-0')); ?>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <?= form_input(array('type' => 'date', 'name' => 'txtfechaqueja', 'id' => 'txtfechaqueja',  'class' => 'form-control col-sm-9 col-md-12')); ?>
                                                    </div>
                                                ...
                                                <div class="form-group row mr-1">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <?= form_textarea(array('rows' => '4', 'name' => 'descripcion', 'id' => 'descripcion', 'placeholder' => 'Registre la discripción de la acción de mejora que se requiere', 'class' => 'form-control col-sm-9 col-md-12')); ?>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mr-1">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <?= form_input(array('type' => 'date', 'name' => 'txtfechaE', 'id' => 'txtfechaE',  'class' => 'form-control col-sm-9 col-md-12')); ?>
                                                    </div>
                                                </div>   
                                                <div class="justify-content-center  mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                                                    <div class="offset-md-3 col-md-9 text-nowrap">
                                                        <?= form_button(array('type' => 'button', 'id' => 'btn_guardar_nuevo', 'name' => 'btn_guardar_nuevo', 'content' => '<i class="fa fa-check mr-1"></i>Guardar', 'class' => 'btn btn-info btn-bold px-4')); ?>
                        ...
                        <section class="form-group" id="sec_SucesosS">    
                            
                                <h3 class="card-title text-125 text-center text-primary-d2">
                                    Datos de Hallazgo del Suceso de seguiridad  
                                </h3> 
                                <br>
                                <hr class="border-dotted my-35"> 
                                        ...
                                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
                                            ...
                                            <div class="col-sm-12 mb-2 mb-sm-0">
                                                <div class="form-group row mr-1">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <div class="action-buttons">
                                                            <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" id="btn_consultarSS">
                                                                <i id="btn_consultarSS" class="fa fa-search-plus text-105"></i>
                                                            </button>
                                                        </div>
                                                    </div>                                                    
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <table id="HallazgoRondas-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
                                                        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
                                                            <tr>                                                                
                                                                <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Id</th>
                                                                <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Fecha Suceso</th>
                                                                <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Servicio</th>
