...
?>
    ...
    <input type="hidden" name="opc_pag" id="opc_pag" value="revision">
      ...
      <div class="card acard mt-2 mt-lg-3">
        ...
        <div class="card-body px-3 pb-1">
          <?= form_open(base_url('d_solicitud/guardar_revision'), array('id'=>'form_revision', 'name'=>'form_revision', 'class'=>'mt-lg-3', 'autocomplete'=>'on')); ?>
            ...
            <div class="form-body " style=" justify-content:flex-start;" >
                ...
                <div class="form-group row" >
                   <?= form_label('Solicitud N°:','', array('class'=>'control-label text-right col-md-4')); ?>
                    <div class="col-md-6 text-primary"><strong><?=$c_id_solicitud; ?></strong></div>
                </div>
                <div class="form-group row" >
                   <?= form_label('Nombre del Documento: ','', array('class'=>'control-label text-right col-md-4')); ?>
                    <div class="col-md-6 text-primary"><strong><?=$c_nombre_documento;?></strong></div>
                </div>
                    ...
                    <div class="card border-0 shadow-sm radius-0" id="card-2">
                      <div class="card-header bgc-primary-d1">
                        <h5 class="card-title text-white">
                          ...
                          Asignados para revisar la solicitud
                          <br>
                        </h5>
                      </div>
                      ...
                      <div class="card-body bgc-transparent p-0 border-1 brc-primary-m3 border-t-0">
                        <div class="container-fluid">
                          <div class="form-horizontal m-t-20" id="quienRevisa">
                          </div>
                        </div>
                      </div><!-- /.card-body -->
                    </div>
