...
<div class="card acard mt-2 mt-lg-3">
	<div class="card-header">
        <h3 class="card-title text-125 text-primary-d2">
          <i class="fas fa-coins text-dark-l3 mr-1"></i>
          Centros de Costos
        </h3>
    </div>
	<div class="row mt-3">
			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nuevo_centro">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nuevo_centro">Nuevo</span>
			          </button>
			          </div>
			        </div>
			      </div>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('a_centros/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
					        ...
					        <div class="card-body px-3 pb-1">
	                			<div class="form-body">
	                				...
	                				<div class="form-group row" id="div_codigo">
					                    ...
					                    <div class="col-sm-8">
					                        <?= form_input(array('type'=>'text', 'name'=>'codigo', 'id'=>'codigo', 'placeholder'=>'Digite el Código', 'maxlength'=>'8', 'class'=>'form-control col-sm-8 col-md-9'));?>
					                    </div>
					                </div>
			                    <div class="form-group row" id="div_nombre">
			                     ...
			                     <div class="form-group row" id="div_lineacostos">
				                    <div class="col-sm-4 col-form-label text-sm-right pr-0">
					                    <?= form_label('Línea de Costo','lineacostos', array('class'=>'mb-0')); ?>
					                </div>
					                <div class="col-sm-4">
					                    <?= select_lineacostos_tabla('centros','','select2 form-control');?>
					                </div>
					            </div>
