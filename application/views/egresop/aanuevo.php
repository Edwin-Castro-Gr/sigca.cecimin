        ...
        <div class="col-12">
          <div class="card dcard">
            <div class="card-body px-3 pb-1">
              <?= form_open(base_url('c_egresop/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'mt-lg-3', 'autocomplete'=>'off')); ?>
                ...
                <div class="form-body " style=" justify-content:flex-start;" >
                  ...
                  <div class="form-group row" id="div_tipo">
                    ...
                    <div class="col-sm-4">
                      <?= select_empleados_tabla('egresop','','form-control');?>
                    </div>                 
                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                      <?= form_label('Contrato *','contratos', array('class'=>'mb-0')); ?>
                    </div>
                    <div class="col-sm-4">
                      <?= form_dropdown('contratos', '', '', 'class="form-control " id="contratos"');?>
                    </div>  
                  </div>
                  ...
                  <div class="container " id="div_parte7">                    
                    <div class="col-form-label text-sm-left pr-0">
                       <?= form_label('Elementos a devolver','elementos', array('class'=>'mb-0')); ?>
                    </div>
                    <div class="col-sm-4">
                      <label class="mt-1 mt-sm-0 ml-sm-3">
                        <input type="checkbox" class="input-lg bgc-blue" id="carnet" name="carnet"  />
                        Carnet de identificación de empleado
                      </label>
                      <label class="mt-1 mt-sm-0 ml-sm-3">
                        <input type="checkbox" class="input-lg bgc-blue" id="computador" name="carnet"  />
                        Computador portátil y accesorios ( si aplica)
                      </label>
                    </div>                    
                  </div><!-- /.card --> 
