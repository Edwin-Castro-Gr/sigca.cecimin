			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        <h3 class="text-125 pl-1 mb-3 mb-sm-0 text-secondary-d4">
			          Listado de Politicas de la Empresa
			        </h3>
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nueva_politica">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nueva_politica">Nuevo</span>
			          </button>
			          </div>
			        </div>
			      </div>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('a_politicas/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
					        ...
					        <div class="card-body px-3 pb-1">
	                			<div class="form-body">
				                    ...
				                    <div class="form-group row" id="div_descripcion">
				                      ...
				                      <div class="col-sm-8">
				                        <?= form_textarea(array('rows'=>'5', 'name'=>'descripcion', 'id'=>'descripcion', 'placeholder'=>'Ingrese la descripción de la politica', 'class'=>'form-control'));?>
				                      </div>
				                    </div>
